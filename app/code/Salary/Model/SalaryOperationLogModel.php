...
class SalaryOperationLogModel extends BaseModel
{
	...
	public static function getActionLabels()
	{
		return array(
			...
			'commission_project_save' => '保存提成项目规则',
			'commission_project_delete' => '删除提成项目规则',
			'commission_generate' => '生成月提成核算表',
			'commission_save' => '保存月提成核算表',
			...
			'commission_estimate_delete' => '删除提成测算记录',
			'initial_salary_save' => '保存初始工资表',
			'initial_salary_employee_save' => '保存员工初始工资',
			...
			'payroll_save' => '保存工资表',
			'payroll_project_order_save' => '调整月工资项目顺序',
			...
			'mobile_payslip_view' => '手机端查看本人薪酬',
			'mobile_payslip_confirm' => '手机端确认工资条',
