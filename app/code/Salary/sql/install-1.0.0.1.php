...
$db->execute("CREATE TABLE IF NOT EXISTS `{$templateTable}` (
  ...
  `source_type` varchar(20) NOT NULL DEFAULT 'fixed',
...
$now = time();
$templates = array(
	array('base_salary', '基本工资', 'fixed', 'earning', 'fixed', 'none', 1, 0, 1, 10),
	array('position_salary', '岗位工资', 'fixed', 'earning', 'fixed', 'none', 1, 0, 1, 20),
	array('fixed_allowance', '固定补贴', 'fixed', 'earning', 'fixed', 'none', 1, 0, 1, 30),
	array('fixed_deduction', '固定扣款', 'fixed', 'deduction', 'fixed', 'none', 0, 1, 1, 40),
	...
	array('bonus', '奖金', 'calculated', 'earning', 'manual', 'none', 1, 0, 1, 70),
	array('overtime_pay', '加班费', 'calculated', 'earning', 'manual', 'none', 1, 0, 1, 80),
	array('leave_deduction', '请假扣款', 'calculated', 'deduction', 'manual', 'none', 0, 1, 1, 90),
	array('social_security', '社保个人部分', 'calculated', 'deduction', 'manual', 'none', 0, 1, 1, 100),
	array('housing_fund', '公积金个人部分', 'calculated', 'deduction', 'manual', 'none', 0, 1, 1, 110),
	array('individual_tax', '个税', 'calculated', 'deduction', 'manual', 'none', 0, 1, 1, 120),
);
