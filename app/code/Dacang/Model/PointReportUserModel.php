...
class  PointReportUserModel extends BaseModel
{
	...
	public static  function factory()
	{
		...
		{
			self::$_instance = new PointReportUserModel();
		}
	...
	public function setStatus($reportId,$uid)
	{
		...
		$reportuser = PointReportUserModel::findFirst('report_id = '.$reportId.' and user_id = '.$uid) ;
