...
class  ReportModel extends BaseModel
{
	...
	{
		$this->setSource($this->getTableName("report"));
	}
	...
	public static  function factory()
	{
		...
		{
			self::$_instance = new ReportModel();
		}
	 ...
	 * @date	2017年5月3日
	 */
	public function showPoint($reportId,$quotaId,$companyId,$page,$pagesize)
	{
		$return = new \stdClass();
		if(!$reportId || !$quotaId || !$companyId)
		{
			return $return ;
		}
		...
		$where = ' i.quota_id = '.intval($quotaId).' and i.report_id = '.intval($reportId).' and u.company_id = '.$companyId;
