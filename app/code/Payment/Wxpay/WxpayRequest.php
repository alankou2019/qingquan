<?php
namespace ScshuxCms\Payment\Wxpay;

use ScshuxCms\Payment\Request;
use ScshuxCms\Payment\PaymentUtil;
...
class WxpayRequest extends Request
{
    ...
    public function unifiedOrder()
    {
        ...
        $response = PaymentUtil::postRequest($this->unifiedOrderUrl, $xml);
        return $response;
    }
    ...
    public function orderQuery()
    {
        ...
        $converted['sign'] = strtoupper(PaymentUtil::signParams($converted, '&key=' . $this->options['secret']));

        $xml = $this->toXml($converted);
        $response = PaymentUtil::postRequest($this->orderQueryUrl, $xml);
        return $response;
    }
