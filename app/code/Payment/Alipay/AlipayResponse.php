<?php
namespace ScshuxCms\Payment\Alipay;

use ScshuxCms\Payment\PaymentUtil;
use ScshuxCms\Payment\Response;
...
class AlipayResponse extends Response
{
    ...
    private function confirmSellerSendGoods($trade_no)
    {
        ...
        $html_text = PaymentUtil::postRequest($this->url, $params);
    ...
    {
        return PaymentUtil::signParams($params, $this->options['secret']);
    }
}
