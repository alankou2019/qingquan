...
class Time
{
	 ...
	 * @return void
	 */
	function localMktime($hour = NULL , $minute= NULL, $second = NULL,  $month = NULL,  $day = NULL,  $year = NULL)
	{
		$timezone = 8;
	...
	function localDate($format, $time = NULL)
	{
	 ...
	 * @return  array
	 */
	function localGettime($timestamp = NULL)
	{
		$tmp = $this->localGetdate($timestamp);
		return $tmp[0];
	}
	 ...
	 * @return  array
	 */
	function localGetdate($timestamp = NULL)
	{
		$timezone = 8;
