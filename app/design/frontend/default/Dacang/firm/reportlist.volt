...
<script src="/skin/adminhtml/default/libs/layer/layer.js" type="text/javascript" charset="utf-8"></script>
    ...
    <div class="search_box">
        ...
        <button style=" background-color: #4560e6; border: 1px solid #4560e6;color: #ffffff; line-height:30px; height:32px;width: 100px;" type="button" onclick="makereport()">新建考评表</button>
        </form>
        <!--右侧配置-->
