			...
			<ul class="list_form_full">
				...
				<li class="posi_lm">
					...
					<div class="right posi_m reportitem">
						<table border="1"  class="table_box w1000">
						  	<tr>
						    	<th>指标名称</th>
						    	<th>评分方式</th>
						    	<th>权重</th>
						  	...
						  	<tbody class="reporttr">
						  		...
						  		<tr>
							    	...
							    	<td>
							    	    {{helper.setColor(itemquota.report_id,itemquota.quota_id,itemquota.reportuserids,itemquota.report_user_name)}}
							    	</td>
							    	<td>
							    		<button type='button' onclick='showpoint({{item.id}},{{itemquota.quota_id}})' class='mybutton'> 积分记录  </button>
<!-- 							    		<button type="button" onclick="showcomment({{item.id}},{{itemquota.quota_id}})" class="mybutton">指标点评</button> -->
			...
			<div class="online_btn_box" onclick="window.location='{{helper.createUrl(['p':'pointreport/list'])}}';">
