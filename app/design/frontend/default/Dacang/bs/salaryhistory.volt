<div class="warp salary_mobile_page" id="evaluation">
	...
	<div class="salary_header"><a href="{{helper.createUrl(['p':'bs/salary'])}}">返回</a>往年薪酬</div>
	<div class="salary_summary">
		<div class="line"><span>历史记录</span><strong>{{summary['count']}}</strong></div>
