			...
			<div class="score_details_list score_details_list100">
				...
				<ul class="score_details_list_ul clear">
					<li class="fl clear list_con">
						...
						<div class="fl">
							<div class="txt_top">
								被考核人 <div style="float: right;margin-left:100px;">总分：{{totalpoint}}</div>
							</div>
					...
					{% if details %}
						{% for item in details %}
							<li class="fl clear">
								...
								<div class="fr fen">
                                   <button class="inputfen"  type="button"  onclick="javascript:comment_quota_show(this)" quota_id='{{item.id}}'  
								...
								<div class="fr fen">
									<p class="pointright"> &nbsp;&nbsp;&nbsp;&nbsp;评分：{% if ispoint==0 %}0{% else %}{{helper.del0(item.report_point)}}{% endif %}</p>
									{% if ispoint!=0 %}
