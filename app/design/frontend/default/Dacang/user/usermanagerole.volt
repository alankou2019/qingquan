...
<div class="full_box">
    <div class="full_title">
        ...
        <span style="float: right; cursor: pointer;"
            ...
            class="iconfont icon-shuaxin"></i></span> <span class= "name">管理权限</span> <a
    ...
    <div class="full_cont">
        <!--表单-->
        <form action="{{helper.createUrl(['p':'user/usermanagerolesave'])}}" method="post" class="form_full" id="dataForm" name="dataForm" enctype="multipart/form-data">
