...
<div class="full_box">
	...
	<div class="salary_secondary_navigation"><a href="{{helper.createUrl(['p':'salary/archive'])}}">归档记录</a><a href="{{helper.createUrl(['p':'salary/payslip'])}}">工资条发放</a><a class="on" href="#">报表统计</a><a href="{{helper.createUrl(['p':'salary/log'])}}">操作日志</a></div>
