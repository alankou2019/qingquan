...
<script src="/skin/adminhtml/default/libs/layer/layer.js" type="text/javascript" charset="utf-8"></script>
    ...
    <div class="search_box">
        ...
        <select class="screen" name="filter">
            ...
            <option value="key_code">广告位标识</option>
        </select>
        <!--搜索筛选-->             
        <!--搜索输入框-->
        ...
        <!--搜索按钮-->
        <button class="operate" onclick="window.location='{{helper.createUrl(['p':'advertposition/new'])}}';"><i class="iconfont icon-tianjia"></i>添加广告位</button>
        <!--右侧配置-->
    ...
    <table class="table_box">
        ...
        {% for item in dataList.items %}
        	<tr>
                ...
                <td class="operate">
                    <button class="btn" onclick="window.location='{{helper.createUrl(['p':'advertposition/edit','id':item.id])}}';"><i class="iconfont icon-caozuo"></i>编辑</button>
                ...
                <td class="name">
                    <span class="txt">{{item.name}}</span>
                                ...
                                <td class="name">
                    <span class="txt">{{item.key_code}}</span>
                </td>
                ...
                <td class="name">
                    <span class="txt">{{item.width}} X {{item.height}}</span>
                </td>
