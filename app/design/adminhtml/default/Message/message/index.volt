...
<!--日历插件-->
    ...
    <div class="search_box">
        ...
        <select class="screen" name="filter">
            ...
            <option value="a.nickname">名称</option>
            <option value="a.phone">手机号码</option>
        </select>
        <!--搜索筛选-->             
        <!--搜索输入框-->
        <input type="text" name="keywords" value="" placeholder="请输入搜索条件" class="search"/>
        <span class="time_li"><input placeholder="咨询开始日期" class="laydate-icon dateinput time_li" name="start_time"></span>            
      	<span class="time_li"><input placeholder="咨询结束日期" class="laydate-icon dateinput" name="end_time"></span>
        <!--搜索输入框-->
        <!--搜索按钮-->
...
{% endif %}
    <table class="table_box">
        ...
        <tr class="table_head">
            ...
            <th><span>合作业务</span></th>
            <th><span>建筑面积</span></th>
        ...
        {% for item in dataList.items %}
        	<tr>
                ...
                <td class="operate">
                    <button class="btn" onclick="window.location='{{helper.createUrl(['p':'message/view','id':item.id])}}';"><i class="iconfont icon-caozuo"></i>查看</button>
                ...
                <!--
                <td class="name">
                    <span class="txt">{{item.email}}</span>
                </td>
                 -->
                </td>
                <td class="name">
                ...
                <td class="name">
                    <span class="txt">{{item.company}}</span>
                </td>
                <td class="name">
                    <span class="txt">{{item.company_addr}}</span>
                </td>
                <td class="name">
                    <span class="txt">{{item.cooper_service}}</span>
                </td>
                <td class="name">
                    <span class="txt">{{item.covered_area}}</span>
                </td>
                <td class="name">
                    <span class="txt">{{helper.formatDateTime(item.inputtime)}}</span>
                </td>
                <td class="name">
                    <span class="txt">{{item.ip}}</span>
                </td>
