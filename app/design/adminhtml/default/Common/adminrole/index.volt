...
<script src="/skin/adminhtml/default/libs/layer/layer.js" type="text/javascript" charset="utf-8"></script>
    ...
    <div class="search_box">
        ...
        <!--搜索按钮-->
        <button class="operate" onclick="window.location='{{helper.createUrl(['p':'adminrole/new'])}}';"><i class="iconfont icon-tianjia"></i>添加角色</button>
        <!--右侧配置-->
    ...
    <table class="table_box">
        ...
        {% for item in dataList.items %}
        	<tr>
                ...
                <td class="operate">
                    <button class="btn" onclick="window.location='{{helper.createUrl(['p':'adminrole/edit','id':item.id])}}';"><i class="iconfont icon-caozuo"></i>编辑</button>
                ...
                <td class="name">
                    <span class="txt">  {% if item.is_active %}
                  		正常
                  	{% else %}
                        禁用
                    {% endif %}</span>
