...
<div class="full_box">
	<div class="full_title">
		...
		<span style="float: right; cursor: pointer;"
			...
			class="iconfont icon-shuaxin"></i></span> <span class="name">{% if item %}编辑{% else %}新增{% endif %}单页</span> <a
			class="go_back" onclick="window.location='{{helper.createUrl(['p':'page/index'])}}';"> <i
			class="iconfont icon-fanhui"></i> <span>返回单页列表</span>
		</a>
	...
	<div class="full_cont">
		<!--表单-->
		<form action="{{helper.createUrl(['p':'page/save'])}}" method="post" class="form_full" id="dataForm" name="dataForm" enctype="multipart/form-data">
		     <input type="hidden" name="id" value="">
			<div class="sub_title">单页基本信息</div>
			<ul class="list_form_full">
				...
				<li class="posi_lm">
					...
					<div class="right posi_m">
						<div class="input_clear">
							<input type="text" name="name" datatype="*2-30"  value="" errormsg="标题至少2个字符,最多30个字符！" maxlength="30" />
						</div>
					</div>
				</li>
				
				<li class="posi_lm wrong">
					<div class="left posi_l must">分类:</div>
					<div class="right posi_m">
						<select name="cat_id" class="select_name" datatype="n" errormsg="请选择分类！">
							<option value="">选择单页分类</option>
				...
				<li class="posi_lm">
					...
					<div class="left posi_l must">内容:</div>
					<div class="right posi_m">
						<div class="input_clear">
