...
<div class="full_box">
	<div class="full_title">
		...
		<span style="float: right; cursor: pointer;"
			...
			class="go_back" onclick="window.location='{{helper.createUrl(['p':'quotatpl/index'])}}';"> <i
	...
	<div class="full_cont">
		<!--表单-->
		<form action="{{helper.createUrl(['p':'quotatpl/save'])}}" method="post" class="form_full" id="dataForm" name="dataForm" enctype="multipart/form-data">
			...
			<ul class="list_form_full">
				...
				<li class="posi_lm">
                    <div class="left posi_l must">行业:</div>
                    <div class="right posi_m">
                        <div class="input_clear">
                            <input type="text" name="remark"  datatype="*2-16"  value=""  maxlength="16"/>
                        </div>
                    </div>
                </li>
				...
				<li class="posi_lm">
					...
					<div class="right posi_m">
						<div class="input_clear">
								...
								<input type="radio" value='3' name='type' {% if item.type == 3 %}checked='checked'{% endif %}/>  比重
						</div>
					</div>
				</li>
				...
				<li class="posi_lm">
					...
					<div class="right posi_m">
						<div class="input_clear">
							<textarea name="point_desc" id="content"  style="width:100%;max-width:1000px;height:300px;" ></textarea>
						</div>
					</div>
				</li>
			</ul>
